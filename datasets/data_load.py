...
def load_data():
   cur,conn=create_connection()
   titles_file = r"/home/samir/test-dbt-install/test_project/datasets/titles.csv" # <- Replace with your path.
   titles_delimiter = "," # Replace if you're using a different delimiter.
   credits_file=r"/home/samir/test-dbt-install/test_project/datasets/credits.csv"
   credits_delimiter=","
